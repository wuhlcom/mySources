...
public class TestThreadLocal {
    ...
    private static String threadC = "thread1";
    private static final String threadD = "thread2";
    ...
    public static String getThreadC(){
        return threadC;
    }

    public static void setThreadC(String value){
        threadC=value;
    }
